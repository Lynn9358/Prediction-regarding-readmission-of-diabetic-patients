...
\end{subfigure}
\caption{Histograms for Age, Number\_inpatient and Diag\_recode versus Readmitted}
\end{figure}
...
\toprule
variables                  & patient.age                   & time\_in\_hospital         & num\_lab\_procedures             & num\_medications       & num\_outpatient    & num\_emergency      \\
\multicolumn{1}{c}{values} & \multicolumn{1}{c}{{[}30-40)} & \multicolumn{1}{c}{2 days} & \multicolumn{1}{c}{44 lab tests} & \multicolumn{1}{c}{16} & \multicolumn{1}{c}{0} & \multicolumn{1}{c}{0}  \\
\bottomrule
\end{tabular}
\end{table}
